module github.com/defenseunicorns/zarf-package-big-bang/bb-zarf-generator
...
require (
	...
	github.com/distribution/distribution/v3 v3.0.0-20220612151901-b5e2f3f33dbc // indirect
